...
class TestMappingPreservesValidFields:
    async def test_p1p2_zero_unavailable_fields_are_not_reported_as_measurements(self, daikin_client: DaikinOne) -> None:
        ...
        assert unit.equipment_status is DaikinThermostatStatus.COOLING
        assert unit.discharge_temperature is None
        assert unit.eev_open_pulses is None
