...
#
# These fields are reported by Daikin mini- and multi-split systems.  Unlike
# the conventional-equipment fields above, unavailable P1/P2 telemetry is
# commonly encoded as zero.  Decode it to None so HA renders it as
# "unavailable" instead of a plausible-looking but false measurement.
...
F_P1P2_STATUS = IntField("P1P2S21equipmentStatus", Sentinel.U8)
...
F_P1P2_FAN_SPEED = IntField("P1P2IndoorUnitFanSpeed", 0)
F_P1P2_FLAP_SWING = IntField("P1P2IndoorUnitFlapSwing", Sentinel.U8)
F_P1P2_SUCTION_TEMP = CelsiusField("P1P2IndoorSuctionAirThermistor", min_c=0.01)
F_P1P2_DISCHARGE_TEMP = CelsiusField("P1P2IndoorUnitDischargeAirThermistor", min_c=0.01)
...
F_P1P2_EEV_OPEN_PULSES = IntField("P1P2IndoorUnitEEVOpenPulses", 0)
F_P1P2_GAS_PIPE_TEMP = CelsiusField("P1P2IndoorUnitHeatExchangerGasPipeThermistor", min_c=0.01)
F_P1P2_HEAT_EXCHANGER_TEMP = CelsiusField("P1P2IndoorUnitHeatExchangerThermistor", min_c=0.01)
