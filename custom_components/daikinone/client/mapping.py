...
def _map_p1p2_split_unit(payload: DaikinDeviceDataResponse) -> DaikinSplitUnit | None:
    ...
    return DaikinSplitUnit(
        ...
        equipment_status=DaikinThermostatStatus(read(payload.data, f.F_P1P2_STATUS)),
        ...
        fan_speed_percent=read(payload.data, f.F_P1P2_FAN_SPEED),
        flap_swing=read(payload.data, f.F_P1P2_FLAP_SWING),
        suction_temperature=read(payload.data, f.F_P1P2_SUCTION_TEMP),
        discharge_temperature=read(payload.data, f.F_P1P2_DISCHARGE_TEMP),
        operating_time=read(payload.data, f.F_P1P2_OPERATING_TIME),
        energized_time=read(payload.data, f.F_P1P2_ENERGIZED_TIME),
        fan_operation_time=read(payload.data, f.F_P1P2_FAN_OPERATION_TIME),
        eev_open_pulses=read(payload.data, f.F_P1P2_EEV_OPEN_PULSES),
        gas_pipe_temp=read(payload.data, f.F_P1P2_GAS_PIPE_TEMP),
        heat_exchanger_temp=read(payload.data, f.F_P1P2_HEAT_EXCHANGER_TEMP),
        fan_tap_active=optional_bool(f.F_P1P2_FAN_TAP),
